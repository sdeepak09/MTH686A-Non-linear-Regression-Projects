...
x=q1_c(c(10,20,30,50),1000,1.5,2,c(0.05,0.1,0.9,0.95))
x$percentile_points_for_a
x=q1_c_2(c(10,20,30,50),1000,1.5,2,c(0.05,0.1,0.9,0.95))
x$percentile_points_for_a
x$est_coefs
